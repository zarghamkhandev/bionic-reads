  ...
  return (
    <section className="mt-24 text-gray-600">
      ...
      <div className="container flex flex-col flex-col-reverse items-center px-5 pt-24 mx-auto mt-40 md:flex-row md:items-start">
        <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 md:items-start md:text-left md:mb-0">
          ...
          <p className="mb-8 leading-relaxed tracking-tighter">
            ...
            ultimately your websites' performance. The engagement graph shows
            you how much of your voicy people listened to and where you lose
            them.
          </p>
          <nav className="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
            <a className="text-sm">
        ...
        <div className="w-5/6 lg:max-w-lg lg:w-1/2 md:w-1/2 md:pl-10">
          <img
            className="object-cover object-center border border-gray-200 rounded-xl"
            alt="hero"
      ...
      {/* <div className="container flex flex-col items-center px-5 pt-24 mx-auto md:flex-row md:items-center">
        <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 md:pr-6 md:items-start md:text-left md:mb-0">
          <h1 className="mb-4 text-xl font-semibold tracking-tighter text-gray-900 title-font sm:text-5xl ">
            Use vocal CTA's
          </h1>
          <p className="mb-8 leading-relaxed tracking-tighter">
