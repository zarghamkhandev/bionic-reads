        ...
        <div className="flex w-full mx-auto text-left">
          <div className="relative inline-flex items-center mx-auto align-middle">
            <div className="text-center">
              <h1 className="w-full text-3xl font-bold text-grey-100 md:text-5xl lg:text-6xl text-slate-700">
              ...
              <p className="max-w-xl mx-auto mt-8 text-xl leading-relaxed text-gray-500 ">
                Use voice widgets to speak to your audience or collect voice
