        ...
        <div className="flex w-full mx-auto text-left">
          <div className="relative inline-flex items-center mx-auto align-middle">
            <div className="text-center">
              <h1 className="w-full text-3xl tracking-tighter font-bold text-grey-100 md:text-5xl lg:text-6xl text-slate-700">
              ...
              <p className="max-w-xl tracking-tighter mx-auto mt-8 text-xl leading-relaxed text-gray-500 ">
              ...
              <div className="flex justify-center w-full max-w-2xl gap-2 mx-auto mt-6">
                <div className="mt-3 rounded-lg sm:mt-0">
                  <button className="items-center tracking-tighter block px-5 py-4 text-base font-normal text-center text-white transition duration-500 ease-in-out transform bg-gradient-to-r from-[#a994e8] to-[#886adb] hover:bg-[#F6F3FB] text-white  lg:px-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Start now - it's free
                  </button>
                </div>
              </div>
