...
<section className="relative py-16 bg-white min-w-screen animation-fade animation-delay">
        <div className="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
          <p className="text-xs mb-5 font-bold text-left text-our-500 uppercase sm:mx-6 sm:text-center sm:text-normal sm:font-bold">
            Got a Question? We’ve got answers.
          </p>
          <h3 className="mt-1 mb-20 text-2xl font-bold text-left text-gray-800 sm:mx-6 sm:text-3xl md:text-4xl lg:text-5xl sm:text-center sm:mx-0">
          ...
          <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3 rounded-3xl">
            <h3 className="text-lg font-bold text-our-700 sm:text-xl md:text-2xl">Will voicys slow down the speed of my website?</h3>
            <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
            No, don't worry about that.
            </p>
          </div>
          <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3 rounded-3xl">
            <h3 className="text-lg font-bold text-our-700 sm:text-xl md:text-2xl">How do I add the voicys on my website?</h3>
            <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
          ...
          <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3 rounded-3xl">
            <h3 className="text-lg font-bold text-our-700 sm:text-xl md:text-2xl">I have surpassed my monthly views and need more, what should I do?</h3>
            <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
            No worries. Simply upgrade to a higher plan or reach out to us for a custom solution.
            </p>
          </div>
          <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3 rounded-3xl">
            <h3 className="text-lg font-bold text-our-700 sm:text-xl md:text-2xl">What happens to my voicys when my free trial expires?</h3>
            <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
